...
int MazeGenerator::randomIntCreator() {
    ...
    int min = 51; // Min Original is always 51, only change for debugging purposes
    int max = 81; // Max Original is always 81, only change for debugging purposes
...
void MazeGenerator::renderMaze() {
    ...
    // Hand off the finished blueprint to the Decorator
    LevelPopulator::populate(this);
